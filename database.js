...
const settingsSchema = new mongoose.Schema({
    ...
    min_deposit: { type: Number, default: 1000 }, // MINIMAL DEPOSIT RP 1.000
    ...
    async initializeSettings() {
        ...
        if (!settings) {
            await Settings.create({ 
                name: 'main_settings',
                min_deposit: 1000,  // DEFAULT MINIMAL DEPOSIT RP 1.000
                max_deposit: 1000000,
                maintenance: false
            });
            console.log('✅ Default settings created with min deposit Rp 1.000');
        } else {
            // FORCE UPDATE KE 1000 JIKA MASIH 10000
            if (settings.min_deposit !== 1000) {
                ...
                console.log('🔄 Settings updated: Minimal deposit sekarang Rp 1.000');
            } else {
                console.log('✅ Settings already set to min deposit Rp 1.000');
            }
        }
    }
...
module.exports = {
    ...
    initializeDB: async () => {
        ...
        console.log('💰 Minimal deposit: Rp 1.000');
        return db;
    }
};
